...
public class Day5DialogContent : MonoBehaviour
{
    ...
    void PackContent()
    {
        ...
        content.Add("Sister_FinishTask", new Dialog
        {
            ...
            lines = new string[] {
                "<i>WHAT?</i>",
                "Oh no, brother. Those trees will no longer bear fruit if there has been a fire.",
        ...
        content.Add("Grandmother_FinishTask", new Dialog
        {
            character = Character.Grandmother,
            lines = new string[] {
              "Beautiful. The ancestors truly live on in you now! I am getting quite old, young one, so you must carry on this tradition.",
