...
1) First thing's first, add a Boundary Builder to your scene. You can do this by using the toolbar GameObject->UmbraEvolution->UmbraBoundaryBuilder->Add Boundary Builder.
