...
//Last Updated: Aug.22.2019 by Robert MacGillivray
    ...
    public class BoundaryNode : MonoBehaviour
    {
        ...
        public void DrawPhysicalNodeGizmosManually()
        {
            ...
            if (!PhysicalNodeGizmo)
            {
                ...
                tempRenderer.sharedMaterial = new Material(Resources.Load<Material>("UmbraBoundary_Gizmo"));
            }
        ...
        public Vector3[] ReturnVertices(float heightAdjustment)
        {
            ...
            vertices[0] = transform.position + (transform.right * ParentBoundary.boundaryThickness / 2f) + (transform.up * (ParentBoundary.verticalOffset + heightAdjustment));
            vertices[1] = transform.position + (-transform.right * ParentBoundary.boundaryThickness / 2f) + (transform.up * (ParentBoundary.verticalOffset + heightAdjustment));
