...
namespace UmbraEvolution
{
    public class Boundary : MonoBehaviour
    {
        ...
        public void DrawGizmos(BoundaryNode triggeringNode = null)
        {
            ...
            if (BoundaryNodes.Count > 1)
            {
                ...
                for (int index = 0; index < indexLimit; index++)
                {
                    ...
                    //The distance between the two nodes (this will be the width of the gizmo)
                    float gizmoWidth = Vector3.Distance(nodeOneAdjusted, nodeTwoAdjusted);
        ...
        public void GenerateMesh()
        {
            ...
            BoundaryMeshRenderer.sharedMaterial = Resources.Load<Material>("UmbraBoundary_Fade");
