...
namespace ShadedTechnology.GrassPhysics
{
    ...
    public class GrassPhysicsCameraInspector : Editor
    {
        ...
        {
            Vector2Int texSize = EditorGUILayout.Vector2IntField("Texture Resolution", myTarget.textureSize);
            myTarget.textureSize = new Vector2Int(Mathf.Max(texSize.x - (texSize.x % GlobalConstants.STEP_PX), GlobalConstants.STEP_PX),
