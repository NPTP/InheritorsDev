...
namespace ShadedTechnology.GrassPhysics
{
    ...
    public class AssetsManager : Editor
    {
        ...
        {
            string path = GetGrassAssetPath() + "/Shaders/GrassTrailEffect.compute";
        ...
        public static void SetGrassShaderSettings(bool multiMode, bool simpleMode, bool fullMode)
        {
            ...
            string filePath = GetGrassAssetPath() + "/Shaders/GrassSettings.cginc";
        ...
        public static void ResetGrassPhysicsSettings()
        {
            ...
            string filePath = GetGrassAssetPath() + "/Shaders/GrassPhysicsSettings.cginc";
            if (!CheckIfFileAndStringAreTheSame(filePath, content))
            {
                WriteStringToFile(filePath, content);
                AssetDatabase.Refresh();
        ...
        {
            string includeFilePath = GetGrassAssetPath() + "/Shaders/GrassSurface.cginc";
