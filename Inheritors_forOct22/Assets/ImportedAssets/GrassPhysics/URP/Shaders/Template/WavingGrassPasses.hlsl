...
#include "Assets/GrassPhysics/Shaders/GrassSettings.cginc"
...
float2 GrassDoWind(inout float4 color, float4 vertex)
{
	...
	color = tintColor;//float4(lerp(color.rgb, tintColor.rgb, _WavingTint.a), color.a);
...
#include "Assets/GrassPhysics/Shaders/GrassSurface.cginc"
